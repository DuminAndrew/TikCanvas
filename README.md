...
- [x] Drag-n-drop устройств на карту
- [x] Рисование линков между устройствами
- [x] Сохранение/загрузка проекта (`*.tikcanvas`)
- [x] Встроенный SSH-терминал (внешний клиент)
- [x] Backup-менеджер конфигов (`/export`)
- [x] Светлая тема (toggle в `View`)
- [x] Мульти-язычность (i18n: RU/EN)
- [ ] Встроенный SSH с эмулятором терминала (libssh2)
- [ ] Realtime-мониторинг трафика интерфейсов
